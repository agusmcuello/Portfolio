...
function SobreMi() {
  return (
    <div name="about" className="w-full h-screen pt-10 bg-[#0a192f] text-gray-300">
      <img className=" absolute sm:top-auto top-[700px] mt-10 left-36 sm:left-[300px] w-[100px] sm:w-[220px] h-[100px] sm:h-[220px] pt-4 hover:scale-110 hover:-rotate-6 hover:duration-500 -rotate-3" src={yo} alt="yo" />
